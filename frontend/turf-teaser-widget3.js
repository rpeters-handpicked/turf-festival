class TurfTeaser3 extends HTMLElement {
  constructor() {
    super()
  ...
  get baseUrl() {
    const script = document.querySelector('script[src*="turf-teaser-widget3"]')
  ...
  // Kleurcode per thema (dot voor de pill)
  get themaColors() {
    return { talks: '#e85d3a', live: '#b066f5', night: '#4a90d9' }
  }

  // ── Favorites — gedeelde key met turf-widget + teaser-widget 1 & 2 ─────────
  getFavorites() {
  ...
  renderCard(e, type) {
    const dag = this.dagLabels[e.dag] || { short: e.dag }
  ...
  getStyles() {
    ...
    return `
      ...
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      /* ── KAARTGROOTTES ── */
      .event-card { grid-column: span 1; grid-row: span 1; }
      .event-card.card-large { grid-column: span 2; grid-row: span 2; }
      ...
      /* grotere padding voor hero-kaart */
...
customElements.define('turf-teaser3', TurfTeaser3)
